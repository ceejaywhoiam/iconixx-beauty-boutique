...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ICONIXX Beauty — Soft Luxury Cosmetics by Shara Frison" },
      { name: "description", content: "Discover ICONIXX Beauty: luxury matte lip glosses, palettes, mascara, and liners crafted for soft glam and boss-girl confidence." },
      { name: "author", content: "ICONIXX Beauty" },
      { property: "og:title", content: "ICONIXX Beauty — Soft Luxury Cosmetics" },
